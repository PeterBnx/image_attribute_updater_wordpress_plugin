<?php
/*
 * Plugin Name:       Binis Plugin
 * Plugin URI:        https://binis.gr/plugins/binis-plugin
 * Description:       Ενημέρωση alt, title, description, caption εικόνων από με βάση τον τίτλο του προϊόντος και το όνομα της επιχείρισης 
 * Version:           1.0
